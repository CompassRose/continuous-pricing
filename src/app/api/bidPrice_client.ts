...
export class PosDailyFare implements IPosDailyFare {
    pointOfSale!: string;
    sa!: (number | undefined)[];
    buckets!: BucketDailyFare[];

    constructor(data?: IPosDailyFare) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.pointOfSale = _data["pointOfSale"];
            if (Array.isArray(_data["sa"])) {
                this.sa = [] as any;
                for (let item of _data["sa"])
                    this.sa!.push(item);
            }
            if (Array.isArray(_data["buckets"])) {
                this.buckets = [] as any;
                for (let item of _data["buckets"])
                    this.buckets!.push(BucketDailyFare.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PosDailyFare {
        data = typeof data === 'object' ? data : {};
        let result = new PosDailyFare();
        result.init(data);
        return result;
    }
...
export interface IPosDailyFare {
    pointOfSale: string;
    sa: (number | undefined)[];
    buckets: BucketDailyFare[];
}

export class BucketDailyFare implements IBucketDailyFare {
    rdb!: string;
    adjustedFare?: number | undefined;

    constructor(data?: IBucketDailyFare) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.rdb = _data["rdb"];
            this.adjustedFare = _data["adjustedFare"];
        }
    }

    static fromJS(data: any): BucketDailyFare {
        data = typeof data === 'object' ? data : {};
        let result = new BucketDailyFare();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["rdb"] = this.rdb;
        data["adjustedFare"] = this.adjustedFare;
        return data;
    }
}

export interface IBucketDailyFare {
    rdb: string;
    adjustedFare?: number | undefined;
}

export class DailyFare implements IDailyFare {
    posInfluences?: PosDailyFare[] | undefined;

    constructor(data?: IDailyFare) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["posInfluences"])) {
                this.posInfluences = [] as any;
                for (let item of _data["posInfluences"])
                    this.posInfluences!.push(PosDailyFare.fromJS(item));
            }
        }
    }

    static fromJS(data: any): DailyFare {
        data = typeof data === 'object' ? data : {};
        let result = new DailyFare();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.posInfluences)) {
            data["posInfluences"] = [];
            for (let item of this.posInfluences)
                data["posInfluences"].push(item.toJSON());
        }
        return data;
    }
}

export interface IDailyFare {
    posInfluences?: PosDailyFare[] | undefined;
}
